...
CHECKS = [
    ...
    {"name": "Validate plugin packages are installable", "cmd": ["python", "sysadmin-analytics-agent-kb/tools/validate_plugin_packages.py"]},
    {"name": "Validate plugin release reaches installed copies", "cmd": ["python", "sysadmin-analytics-agent-kb/tools/validate_plugin_release.py", "--base", "HEAD^"]},
