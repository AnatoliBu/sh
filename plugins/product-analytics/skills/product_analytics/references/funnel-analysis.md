<!-- generated by sysadmin-analytics-agent-kb/tools/build_plugin_from_domain.py from sysadmin-analytics-agent-kb/analytics/skills/funnel-analysis.md — edit the source, not this copy -->
...
1. [Internal tracking plan / event taxonomy](cards/internal-event-taxonomy.md).
2. [Internal metric catalog](cards/internal-metric-catalog.md).
