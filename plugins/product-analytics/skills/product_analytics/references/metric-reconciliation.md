<!-- generated by sysadmin-analytics-agent-kb/tools/build_plugin_from_domain.py from sysadmin-analytics-agent-kb/analytics/skills/metric-reconciliation.md — edit the source, not this copy -->
...
1. [Internal metric catalog / semantic layer](cards/internal-metric-catalog.md).
2. [Internal event taxonomy / tracking plan](cards/internal-event-taxonomy.md).
