<!-- generated by sysadmin-analytics-agent-kb/tools/build_plugin_from_domain.py from sysadmin-analytics-agent-kb/agent-tooling/patterns/contract-validation-checklist.md — edit the source, not this copy -->
