<!-- generated by sysadmin-analytics-agent-kb/tools/build_plugin_from_domain.py from sysadmin-analytics-agent-kb/browser-automation/rules/browser-automation-safety.md — edit the source, not this copy -->
