<!-- generated by sysadmin-analytics-agent-kb/tools/build_plugin_from_domain.py from sysadmin-analytics-agent-kb/video-color/skills/color-correction-shot-matching.md — edit the source, not this copy -->
