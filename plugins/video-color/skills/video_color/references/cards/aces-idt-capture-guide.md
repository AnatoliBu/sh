<!-- generated by sysadmin-analytics-agent-kb/tools/build_plugin_from_domain.py from sysadmin-analytics-agent-kb/references/aces-idt-capture-guide.md — edit the source, not this copy -->

# ACES IDT Capture Guide for Prosumer Cameras
