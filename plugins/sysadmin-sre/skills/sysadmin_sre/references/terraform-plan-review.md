<!-- generated by sysadmin-analytics-agent-kb/tools/build_plugin_from_domain.py from sysadmin-analytics-agent-kb/sysadmin/skills/terraform-plan-review.md — edit the source, not this copy -->
...
- [Terraform MCP Server](cards/terraform-mcp.md)
...
3. [Terraform MCP Server](cards/terraform-mcp.md) for current docs context.
