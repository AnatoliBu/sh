<!-- generated by sysadmin-analytics-agent-kb/tools/build_plugin_from_domain.py from sysadmin-analytics-agent-kb/sysadmin/skills/k8s-manifest-review.md — edit the source, not this copy -->
...
- [Kubernetes Pod Security Standards](cards/kubernetes-pod-security-standards.md)
...
3. [Kubernetes Pod Security Standards](cards/kubernetes-pod-security-standards.md).
